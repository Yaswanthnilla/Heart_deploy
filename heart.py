...
def predict1():
    ...
    if output==1:
         return render_template("result.html",prediction_text="The person is having heart disease")
    else:
        return render_template("result.html",prediction_text="The person is safe")
